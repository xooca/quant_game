...
for datapipeline,subdatapipeline in dd.dc.data.datapipeline.items():
    ...
    print(all_pipe)
    print(f"{dd.dc.data.paths.base_data_loc}{datapipeline}.pkl")
    print(f"{dd.dc.data.paths.base_data_loc}{datapipeline}.csv")
    df = du.run_pipeline(all_pipe,base_df,f"{dd.dc.data.paths.base_data_loc}{datapipeline}.pkl",f"{dd.dc.data.paths.base_data_loc}{datapipeline}.csv",load_previous=False)