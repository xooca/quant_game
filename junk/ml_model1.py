...
pipe2 = Pipeline([
    ('rv1', de.RollingValues(columns=selected_cols,column_pattern=[],last_ticks=['10','30'],aggs=['mean','mean'],oper = ['-','='],verbose=True)),
    ('rv2', de.RollingValues(columns=selected_cols,column_pattern=[],last_ticks=['10','30'],aggs=['max','max'],oper = ['-','='],verbose=True)),
    ('rv3', de.RollingValues(columns=selected_cols,column_pattern=[],last_ticks=['5','30'],aggs=['max','max'],oper = ['-','='],verbose=True)),
...
pipe3 = Pipeline([
    ...
    ('pv', de.PriceVelocity(freq='10',shift=1,shift_column=selected_cols,shift_column_pattern=[],verbose=True)),
    ('pv2', de.PriceVelocity(freq='5',shift=1,shift_column=selected_cols,shift_column_pattern=[],verbose=True)),
    ('ppi', de.PricePerIncrement(freq='D',shift=1,shift_column=selected_cols,shift_column_pattern=[],verbose=True)),
    ])
...
pipe4 = Pipeline([
    ...
    ('pv3', de.PriceVelocity(freq='D',shift=1,shift_column=selected_cols,shift_column_pattern=[],verbose=True)),
    ('ppi2', de.PricePerIncrement(freq='10',shift=1,shift_column=selected_cols,shift_column_pattern=[],verbose=True)),
    ])
