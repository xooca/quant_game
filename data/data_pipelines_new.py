...
class pipelines:
    ...
    def pipeline_definitions(self):
        ...
        self.price_range_pipe = Pipeline([
            ...
            ('pltbc2', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='15min',breach_type = self.dc.data.pltbc.breach_type)),
            ('pltbc3', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='30min',breach_type = self.dc.data.pltbc.breach_type)),
            ('pltbc4', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='60min',breach_type = self.dc.data.pltbc.breach_type)),
            ('pltbc5', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='90min',breach_type = self.dc.data.pltbc.breach_type)),
            ('pltbc6', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='120min',breach_type = self.dc.data.pltbc.breach_type)),
