...
class pipelines:
    def __init__(self,data_config):
        ...
        self.OHLC_COLUMNS = list(self.data_config.data.common.ohlc_column)
        self.TECHNICAL_IND_PATTERN = list(self.data_config.data.common.technical_indicator_col_pattern)
        self.SELECTED_COLUMNS = list(self.data_config.data.common.selected_columns)
        self.TA_PIPE2_EXCLUDE = list(self.data_config.data.common.ta_pipe2_exclude)
    ...
    def pipeline_definitions(self):
        self.generic_pipeline = Pipeline([
                            ...
                            ('read_fd', de.FilterData(start_date=self.data_config.data.common.read_start_date,end_date=self.data_config.data.common.read_end_date)),
                            ])

        self.save_pipeline = Pipeline([
                            ('save_fd', de.FilterData(start_date=self.data_config.data.common.save_start_date,end_date=self.data_config.data.common.save_end_date)),
                            ])
        ...
        self.price_range_pipe = Pipeline([
            ('pltbc1', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='10min',breach_type = self.data_config.data.pltbc.breach_type)),
            ('pltbc2', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='15min',breach_type = self.data_config.data.pltbc.breach_type)),
            ('pltbc3', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='30min',breach_type = self.data_config.data.pltbc.breach_type)),
            ('pltbc4', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='60min',breach_type = self.data_config.data.pltbc.breach_type)),
            ('pltbc5', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='90min',breach_type = self.data_config.data.pltbc.breach_type)),
            ('pltbc6', de.PriceLastTickBreachCount(column_pattern=[],columns=self.SELECTED_COLUMNS,last_ticks='120min',breach_type = self.data_config.data.pltbc.breach_type)),
            ...
            ('pdrhw2', de.PriceDayRangeHourWise(first_col = 'open',second_col='close',hour_range = self.data_config.data.pdrhw.hour_range,range_type=self.data_config.data.pdrhw.range_type)),
            ('pdrhw3', de.PriceDayRangeHourWise(first_col = 'high',second_col='low',hour_range = self.data_config.data.pdrhw.hour_range,range_type=self.data_config.data.pdrhw.range_type))
            ])

        self.label_creator_pipe = Pipeline([
            ('labelgenerator_1', de.LabelCreator_Light(freq='1min',shift=-15,shift_column=self.data_config.data.common.label_generator_col)),
            ('labelgenerator_2', de.LabelCreator_Light(freq='1min',shift=-30,shift_column=self.data_config.data.common.label_generator_col)),
            ('labelgenerator_3', de.LabelCreator_Light(freq='1min',shift=-60,shift_column=self.data_config.data.common.label_generator_col)),
            ('labelgenerator_4', de.LabelCreator_Light(freq='1min',shift=-45,shift_column=self.data_config.data.common.label_generator_col)),
            ])
